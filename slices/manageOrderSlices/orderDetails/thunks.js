...
export const fetchManageOrderDetails = createAsyncThunk(
  'manageOrderData/fetchDetails',
  fetchManageOrderDataPayloadCreator
);
 ...
 * @returns {Promise} TBD
 */
async function fetchManageOrderDataPayloadCreator(payload) {
